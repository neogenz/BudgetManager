'use strict';
myLib.technical.defineNamespace(app, 'bean.core');
(function initSchema() {
    ...
    AbstractSchema.prototype._checkTypeIntegrityBySchema = function (schema, value, propertyName) {
        if (myLib.technical.isUndefinedOrNull(schema)) {
    ...
    AbstractSchema.prototype._getJsonKey = function (schema, json, key) {
        var jsonKey = null;
        if (myLib.technical.isUndefined(json[key])) {
            ...
            if (myLib.technical.isUndefined(json[persistingName])) {
    ...
    app.bean.core.AbstractSchema = AbstractSchema;
